...
CREATE INDEX idx_dim_date_week_ending ON dim_date(last_day_of_week);
CREATE INDEX idx_dim_date_month_ending ON dim_date(last_day_of_month);
...
WHERE date_id BETWEEN '1977-01-01' AND '1977-01-15';
